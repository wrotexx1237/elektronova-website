...
const NAV_LINKS = [
  ...
  { id: "workers", label: "Punëtorët (HR)", icon: Building2 },
    ...
    <Layout>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <GuideSection
          ...
          title="Menaxhimi i Punëtorëve (HR)"
          subtitle="Regjistrimi, kontratat dhe siguria në punë"
        >
          <div className="space-y-4">
            <p className="text-sm">Moduli i punëtorëve ju lejon të menaxhoni stafin, kontratat e punës dhe pajisjet mbrojtëse.</p>

            <h4 className="font-semibold text-sm">Menaxhimi i stafit</h4>
            <div className="space-y-3">
              <Step number={1} title="Regjistrimi i Punëtorit">
                <p>Shtoni llogari të reja me të gjitha të dhënat: Pozita, Paga, Data e fillimit dhe detajet bankare.</p>
              </Step>
              <Step number={2} title="Gjenerimi i Kontratës">
                <p>Nga detajet e punëtorit, mund të gjeneroni një <strong>Kontratë Pune</strong> profesionale në format PDF, gati për printim dhe nënshkrim.</p>
              </Step>
            </div>

            <h4 className="font-semibold text-sm">Dokumentet & Kontratat</h4>
            <div className="space-y-1 text-sm text-muted-foreground">
              <p>&bull; <strong>Dërgimi i kërkesës</strong> — Klikoni &quot;+&quot; tek dokumenti përkatës për t'i dërguar njoftim punëtorit që të ngarkojë kopjen (psh. Diplomën ose Pasaportën).</p>
              <p>&bull; <strong>Statusi</strong> — Gjurmoni cilat dokumente janë dorëzuar dhe cilat mungojnë.</p>
            </div>

            <h4 className="font-semibold text-sm">Siguria në Punë (PMP)</h4>
            <p className="text-sm text-muted-foreground">Ky seksion siguron që asnjë teknik nuk dalë në terren pa pajisjet mbrojtëse:</p>
            <div className="space-y-3">
              <Step number={1} title="Pajisjet sipas Kategorisë">
                <p>Zgjidhni pajisjet për Kamera, Instalime Elektrike ose Mirëmbajtje.</p>
              </Step>
              <Step number={2} title="Dokumento Dorëzimin">
                <p>Klikoni butonin për të regjistruar në sistem që punëtori ka marrë dhe konfirmuar pajisjet (Kaska, Syzet, Dorezat, etj.).</p>
              </Step>
            </div>

            <Tip>Përdorni bllokun e 'Këshillave Profesionale' në krye të faqes për praktikat më të mira të menaxhimit të resurseve humane.</Tip>
          </div>
        </GuideSection>
