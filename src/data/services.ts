...
export const servicesData: Record<string, Record<string, ServiceContent>> = {
  sq: {
    ...
    'elektricist-urgjent': {
      ...
      useCases: [
        'Lidhje të shkurta dhe shkëndija elektrike',
        'Djegia e paneleve ose siguresave kryesore',
        'Humbje e tensionit në njërën fazë',
        'Defekte pas stuhive apo rrjedhjeve të ujit'
      ],
      technology: [
        'Aparatura për gjetjen e defekteve nën mure',
        'Veshje mbrojtëse kundër harkut elektrik',
        'Pjesë rezervë të menjëhershme për reparim'
      ],
      installationProcess: [
        'Marrja e thirrjes dhe udhëzimi i klientit për siguri',
        'Nisja e menjëhershme e ekipit mobil',
        'Izolimi i defektit dhe stabilizimi i gjendjes',
        'Reparimi i plotë i pikave problematike',
        'Testimi i sigurisë para lëshimit të energjisë'
      ],
      faq: [
        { q: 'A punoni edhe gjatë natës?', a: 'Po, shërbimi ynë urgjent nuk ndalet kurrë, 24 orë në çdo ditë të vitit.' },
    ...
    'smart-home-automatizimi': {
      ...
      description: 'Shndërroni shtëpinë tuaj në një hapësirë inteligjente dhe efikase.',
      longDescription: "Shtëpia e mençur nuk është më një koncept i së ardhmes, ajo është këtu. ElektroNova ofron zgjedhjet më të avancuara për **Smart Home në Kosovë**, duke ju lejuar të keni kontroll të plotë mbi ambientin tuaj përmes një aplikacioni të vetëm. Nga kontrolli i ndriçimit dhe temperaturës deri te automatizimi i roletave dhe rrethojave, ne i bëjmë të gjitha.\n\n### Pse Smart Home në Pejë?\nJetesa moderne kërkon efikasitet. Duke instaluar sisteme inteligjente në Pejë apo Prishtinë, ju mund të reduktoni shpenzimet e energjisë deri në 30%. Imagjinoni që ngrohja të fiket automatikisht kur dilni nga shtëpia dhe të ndizet pak para se të ktheheni. Ose dritat që përshtaten sipas orës së ditës për të krijuar ambientin perfekt. Kjo jo vetëm që shton komoditetin, por edhe rrit vlerën e pronës suaj në tregun e Kosovës.\n\n### Siguria dhe Automatizimi i Integruar\nZgjidhjet tona smart integrohen plotësisht me [Sistemet e Alarmit](/sq/sherbimet/sistemet-alarmit) dhe [Kamerat e Sigurisë](/sq/sherbimet/instalimi-kamerave-sigurise). Nëse sistemi detekton ujë në dysheme apo tym, jo vetëm që do t'ju njoftojë, por mund të mbyllë automatikisht valvulat e ujit apo të ndezë dritat e emergjencës. Kjo është siguria e vërtetë 360 gradë që ElektroNova ofron për klientët e saj.\n\n**Zbuloni më shumë:**\nTeknologjia smart është e lidhur ngushtë me mirëmbajtjen elektrike. Lexoni këshillat tona për: [Instalime Elektrike Profesionale](/sq/sherbimet/instalime-elektrike). Ne përdorim pajisje që punojnë me protokollet më të njohura si Zigbee, Z-Wave dhe Wi-Fi, duke garantuar stabilitet maksimal.\n\n### Shërbimi ynë në Pejë\nSi një kompani lokale në Pejë, ne ofrojmë trajnime të detajuara për përdorimin e sistemit smart. Ne nuk thjesht instalojmë pajisjet; ne edukojmë klientët tanë se si të përdorin teknologjinë për të lehtësuar jetën e tyre të përditshme. Kontaktimi me ne është hapi i parë drejt shtëpisë tuaj të ëndrrave.",
      benefits: [
